 ...
 * data from the external API and return it. The GUI will display
...
public class WeatherApp {
    ...
    public static String getCurrentTime() {
        ...
        // format date 2024-05-21T00:00 (modified based on API)
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH':00'");

        // format and print the current date and time
        String forrmattedDateTime = currentDateTime.format(formatter);

        return forrmattedDateTime;
    }
